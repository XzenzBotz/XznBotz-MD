...
let btn = [{
                        ...
                        xavior.send5ButImg(m.chat, anu, 'XznBot-MD', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, 'XznBot-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, 'XznBot-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, 'XznBot-MD', btn)
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Group`, 'XznBot-MD', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Edit Info`, 'XznBot-MD', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Antilink`, 'XznBot-MD', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'XznBot-MD'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'XznBot-MD'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await xavior.sendButtonText(m.chat, buttons, `Mute Bot`, 'XznBot-MD', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, 'XznBot-MD', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      xavior.send5ButImg(i, txt, 'XznBot-MD', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'My Youtube️',
                                    url: 'https://youtube.com/channel/UCTan41uoODwP2uU0ORuoy3w'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Website Bot',
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      xavior.send5ButImg(yoi, txt, 'XznBot-MD', global.thumb, btn)
		}
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/628988986891?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/628988986891?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
let btn = [{
                        ...
                        xavior.send5ButLoc(m.chat, anu, 'XznBot-MD', global.thumb, btn)
                        }
            break
case 'gopay': {
...
let btn = [{
                                ...
                                urlButton: {
                                    displayText: 'Website Bot',
                                    url: 'https://github.com/XzennzBotz23'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Rules❗',
